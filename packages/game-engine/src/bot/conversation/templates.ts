...
export const SPEECH_TEMPLATES: Record<BotSpeechKind, SpeechTemplatePool> = {
  ACCUSE: {
    NEUTRAL: [
      ...
      "Nói thật nhé, tôi nghi {target} từ nãy, {evidence}.",
      "{evidence}. Nghi {target} đấy, giải thích được không.",
      "Tôi chọn {target}. {evidence}.",
      "Hmm, nghi {target} nhé. {evidence}.",
      "Vote {target} nha, {evidence}, ko đùa.",
      "ủa {target} xạo kìa, {evidence}.",
      "nghi {target}, hóng giải thích vụ {evidence}.",
      "{target} xạo =)), {evidence}.",
      "Mn để ý nhé, tôi nghi {target}, {evidence}.",
      "Nghi {target}. {evidence}. Thế thôi.",
      "tôi nghi {target} thật, {evidence}.",
    ],
    FIRM: [
      "Tôi nghi {target}, {evidence}.",
      "Vote {target} đi, {evidence} rồi còn gì.",
      "Cái này rõ mà: {evidence}. Treo {target}.",
      "Tôi bầu {target}, lý do là {evidence}.",
      "Khỏi vòng vo, chốt {target}. {evidence}.",
      "{evidence}. Với tôi thế là đủ, nghi {target}.",
      "{target} xạo. Chốt. {evidence}.",
      "ko bàn nữa, treo {target}. {evidence}.",
      "{target} xạo rõ rồi, {evidence}, ai theo thì theo.",
      "{evidence}, vote {target}, k thoát được.",
      "Tôi nghi {target} nhất. {evidence}.",
      "Bầu {target}, hết. {evidence}.",
      "Bỏ phiếu {target}. {evidence}.",
    ],
    TENSE: [
      "{target} chứ ai nữa, {evidence}.",
      "Thôi khỏi cãi, {evidence}. Treo {target}.",
      "{target} đang lươn quá đấy, {evidence}.",
      "Tôi chán rồi. Vote {target}, {evidence}.",
      "Tôi nghi {target}, {evidence}, đừng có lươn.",
      "{target} xạo. {evidence}. Cãi nữa đi.",
      "mệt lắm, {target} xạo vl, {evidence}.",
      "{evidence}. {target} giả còn diễn tới bao giờ.",
      "Treo {target} thôi đi, {evidence}.",
      "chịu hết nổi, {target} lươn quá, {evidence}.",
      "{target} láo =)), {evidence} mà còn cãi.",
      "Treo {target}. {evidence}. Xong.",
      "{target} lươn vl, {evidence}.",
    ],
    SOFT: [
      "Mình nghi {target} hơi hơi, tại {evidence}.",
      "Hơi phân vân, nhưng {target} khả nghi, {evidence}.",
      "Có khi {target} đáng ngờ á, {evidence}.",
      "Mình nghiêng về {target}, nghi {target}, tại {evidence}.",
      "Tôi nghi {target} một chút, {evidence}.",
      "hmm nghi {target} nhỉ, {evidence}.",
      "{target} hơi khả nghi á, {evidence}.",
      "mình nghi {target} thôi, {evidence}, chưa chắc.",
      "vote {target} nha, {evidence}. Nói nhẹ thôi.",
      "chắc {target} khả nghi, {evidence}.",
      "Xin lỗi {target} trước nhé, mình nghi {target}, {evidence}.",
      "Nghi {target}, mình đoán vậy. {evidence}.",
      "ơ {target} đáng ngờ, {evidence} mà.",
    ],
    PLAYFUL: [
      "Đặt cửa {target} nhé, nghi {target}, {evidence}.",
      "{target} ơi, {target} xạo kìa, {evidence}.",
      "Thôi tôi vote {target} cho vui, mà {evidence} thật.",
      "Xin phép, tôi nghi {target} một cái, {evidence}.",
      "Tôi nghi {target} =)), {evidence}.",
      "{target} hôm nay diễn hơi lố, {target} giả mà, {evidence}.",
      "kkk {target} xạo lộ rồi, {evidence}.",
      "{target} xui rồi, vote {target} thôi, {evidence}.",
      "cửa {target} nha, nghi {target}, {evidence}.",
      "treo {target} cho xong nhé, {evidence}.",
      "{evidence}, {target} láo còn cười =)).",
      "vote {target} cho vui, {evidence}.",
      "Alo {target}, nghi {target} đó nha, {evidence}.",
    ],
    CURIOUS: [
      "Tôi nghi {target}, {evidence}, thấy sao?",
      "{evidence}. Tôi nghi {target}, mn thấy sao?",
      "Mn để ý {target} đáng ngờ đi, {evidence}.",
      "Nghi {target} nhé, {evidence}. Mọi người nghĩ thế nào.",
      "Tôi nghi {target}, {evidence}. Có ai cùng ý ko?",
      "{target} khả nghi thì sao, {evidence}?",
      "ủa {target} đáng ngờ, {evidence} là sao?",
      "hmm nghi {target}, {evidence}. Ai giải thích hộ?",
      "{evidence}, nghi {target}, nói gì đi?",
      "{target} đáng ngờ, {evidence}. Mn thấy ko?",
      "Tôi nghi {target} đấy, {evidence}, đúng ko?",
      "{target} khả nghi? {evidence} đấy.",
      "để ý {target} khả nghi đi mn, {evidence}.",
    ],
  },
  QUESTION: {
    NEUTRAL: [
    ...
    FIRM: [
      "{target} nói đi.",
      "{target} ơi, ý kiến đâu.",
      "Đến lượt {target} rồi đấy nhé.",
      "{target} trả lời cái nhé.",
      "{target} ơi, nói.",
      "{target} lên tiếng đi.",
      "im hoài vậy {target}, nói đi.",
      "{target} nói thẳng đi, bầu ai?",
      "{target}, nãy giờ im là sao.",
      "{target} phát biểu đi.",
      "ê {target}, nói coi.",
      "{target} đừng im nữa nhé.",
      "Hỏi {target} đấy, trả lời đi.",
    ],
    SOFT: [
      "{target} có muốn nói gì không?",
      "Mình muốn nghe {target} tí nhé.",
      "{target} thấy sao nhỉ?",
    ...
    PLAYFUL: [
      ...
      "alo alo {target}?",
      "{target} ơi tàng hình giỏi ghê =))",
    ],
    TENSE: [
      "{target} định im tới bao giờ?",
      "{target} ơi, nói đi chứ.",
      "Im mãi thế {target} à?",
      ...
      "{target} né hoài vậy?",
      "{target} ơi, còn im nữa là mệt đấy.",
      "nói đi {target} ơi, đừng câu giờ.",
      "{target}, sao im?",
  ...
  REPLY: {
    NEUTRAL: [
      ...
      "Ừ {author} à, tôi hiểu ý.",
      "Trả lời {author} nhé: tôi không nghĩ vậy đâu.",
      "{author} này, tôi nói rồi đó.",
      "{author} à, câu đó tôi thấy thường thôi.",
      "Được rồi {author} ơi, tôi nghe.",
      "ok {author} à, hiểu.",
      "{author} à, hỏi thì tôi trả lời: chưa.",
      "ừ {author} ơi, tôi thấy rồi.",
      "{author} à, nói cũng có lý, nhưng tôi vẫn giữ ý.",
      "hmm {author} à, tôi nói rồi mà.",
      "{author} ơi, tôi trả lời rồi nha.",
      "ừ thì {author} ơi, nói đúng một phần.",
    ],
    PLAYFUL: [
      "{author} à, hỏi khó ghê.",
      "Ơ {author}, hỏi thế ai trả lời được.",
      "{author} từ từ nào.",
      "Ok ok {author} ơi, tôi đây.",
      "{author} à =)) tôi trả lời rồi mà.",
      "kkk {author} à, gắt ghê.",
      "{author} ơi, hỏi xoáy quá.",
      "alo {author} ơi, có tôi.",
      "{author} này, tôi đây.",
      "haha {author} à, chịu.",
      "{author} ơi tôi nghe rõ rồi.",
      "ủa {author} à, hỏi tôi á.",
      "{author} à, hỏi hay, tôi ko biết =))",
    ],
    FIRM: [
      "{author} à, tôi trả lời rồi đấy.",
      "Nghe này {author}: không phải như vậy.",
      "{author} nghe cho rõ nhé.",
      "Nói thẳng với {author} nhé, luôn.",
      "{author} ơi, không.",
      "Trả lời {author} nhé: không.",
      "{author} à, tôi giữ ý.",
      "ko, {author} ơi.",
      "{author}, đọc lại đi.",
      "Nói với {author} nhé, 1 lần thôi.",
      "{author} ơi, nghe kỹ.",
      "Nói rồi, {author} à.",
      "{author} này, tôi ko đổi.",
    ],
    SOFT: [
      ...
      "ừ {author} à, mình nghe nè.",
      "{author} à, nói cũng đúng, mình xin nhận.",
      "hmm {author} à, mình hiểu mà.",
      "{author} ơi, mình ko có ý đó.",
      "ok {author} ơi, mình tiếp thu.",
      "{author} nhé, mình nói nhẹ thôi.",
      "mình trả lời {author} nhé.",
      "{author} à, mình thấy cũng có lý.",
      "dạ {author} ơi, mình đây.",
    ],
    TENSE: [
      "{author} hỏi vậy là sao.",
      "Trả lời {author} nhé, một lần thôi.",
      "{author} ơi, đừng bắt bẻ nữa.",
      "Nói với {author} nhé, cho rõ luôn.",
      "{author} à, đủ rồi.",
      "haizz {author} à.",
      "{author} ơi, hỏi hoài.",
      "ko, {author} à, tôi nói rồi.",
      "{author} thôi đi.",
      "Mệt {author} ghê à.",
      "{author} này, tôi trả lời rồi, đọc lại.",
  ...
  CHALLENGE: {
    NEUTRAL: [
      ...
      "Tôi muốn nghe {author} giải thích nhé.",
      "{author} nói lại cho rõ đi.",
      "{author} giải thích đi.",
      "ơ {author}, nói rõ coi.",
      "{author}, ý là sao?",
      "hmm {author} à, nói kỹ hơn.",
    ...
    FIRM: [
      ...
      "Đừng nói chung chung nhé, {author}.",
      "{author} trả lời thẳng vào đi.",
      "{author} à, chứng minh.",
      "{author} ơi, nói thẳng.",
      "bằng chứng, {author} ơi.",
      "{author} đừng vòng vo nhé.",
      "{author}, rõ ràng đi.",
      "Nói thẳng đi {author} ơi.",
      "{author} giải thích ngay đi.",
      "ko vòng vo, {author} ơi.",
      "{author} à, trả lời.",
    ],
    TENSE: [
      ...
      "{author} nói cho tử tế nhé.",
      "{author} à, lái ghê.",
      "{author} ơi, đừng lươn.",
      "ủa {author}, lái à?",
      "{author} nói vậy là sao, hả?",
      "{author} định lái ai.",
      "lươn vừa thôi {author} ơi.",
      "{author}, ý đồ?",
      "{author} chém cái gì đấy.",
      "ko chấp nhận kiểu {author} nói đâu nhé.",
    ],
    SOFT: [
      "{author} nói thêm chút được không.",
      "Mình chưa hiểu ý {author} lắm, nói thêm xem",
      "{author} giải thích giúp mình nhé.",
      "Cho mình hỏi lại {author} nhé.",
      "{author} ơi, nói kỹ hơn nhé.",
      "hmm {author} à, mình chưa rõ.",
      "{author} nói rõ hơn được ko?",
      "mình hỏi {author} nhẹ thôi, ý là sao?",
      "{author} nhé, giải thích tí.",
      "ừm {author}, ý là gì?",
      "{author} ơi, mình chưa hiểu.",
      "mình muốn {author} nói thêm nhé.",
      "{author}, chút nữa được ko?",
    ],
    PLAYFUL: [
      "{author} chém à?",
      "Ơ {author} ơi, dẫn chứng đâu.",
      "{author} à, nói nghe ghê ta.",
      "Bằng chứng đâu {author} ơi.",
      "{author} nổ à =))",
      "kkk {author} à, nói thật ko.",
      "{author} à, chém gió ghê.",
      "alo {author}, dẫn chứng?",
      "{author} ơi, nói như thật.",
      "ủa {author}, thật hả?",
      "{author} =)) nguồn?",
  ...
  DEFEND: {
    NEUTRAL: [
      ...
      "Khoan, {target} chưa phải sói đâu.",
      "Tha {target} đi, để nói đã.",
      "Tôi tin {target}.",
      "{target} ổn, tôi thấy vậy.",
      "khoan, tin {target} đã.",
      "{target} sạch mà, chưa có gì lạ.",
      "để yên đi, {target} ổn mà.",
      "hmm, {target} ko đáng nghi.",
      "Đừng treo {target}, chưa đủ.",
      "{target} ok mà.",
      "tôi thấy {target} ổn thôi.",
    ],
    SOFT: [
      "Mình thấy {target} không đáng nghi đâu.",
      "Từ từ đã, {target} chưa phải sói.",
      "Mình tin {target} cái.",
      "Đừng đẩy {target} nhé.",
      "Tôi tin {target} mà.",
      ...
      "{target} hiền mà, đừng.",
      "hmm, mình thấy {target} ok.",
      "tha {target} thêm ngày đi.",
      "{target} uy tín mà, từ từ.",
      "mình tin {target}.",
      "ơ, {target} ổn mà.",
    ],
    FIRM: [
      "Không, {target} không phải sói.",
      "Đừng đẩy {target}, nhắm người khác đi.",
      "Tôi bảo đảm {target} ổn.",
      "Đừng treo {target}, mất một ngày.",
      ...
      "đừng đẩy {target}.",
      "{target} an toàn. Khỏi bàn.",
      "Đừng treo {target}, phí phiếu.",
    ],
    TENSE: [
      "Đừng chốt {target}.",
      "Lại {target} à, {target} sạch mà.",
      "Ai đẩy {target} thế, {target} ổn mà.",
      "Thôi tha cho {target} đi.",
      "Đừng treo {target}, vô lý.",
      "{target} vô tội mà, đẩy làm gì.",
      "tha {target} đi, mệt.",
      "haizz, lại {target}, tha {target} đi.",
      "Tôi tin {target}, ai đẩy thì tuỳ.",
      "{target} ko phải sói, thôi.",
      "đẩy hoài, {target} ổn mà.",
      "{target} sạch mà, đẩy gì.",
    ...
    PLAYFUL: [
      ...
      "Tha {target} sống thêm ngày nữa.",
      "Đừng treo {target}, tội =))",
      "{target} dân đen thôi.",
      "kkk {target} sạch mà.",
      "{target} sạch, tôi cá đầu xuống đất.",
      "Tôi tin {target}, cá luôn.",
      "tha {target} đi mn.",
      "{target} hiền khô.",
      "ủa {target} á? {target} vô tội mà.",
      "haha {target} vô tội.",
    ],
    CURIOUS: [
      "Sao lại {target}? Tôi thấy {target} ổn mà.",
      "{target} ổn mà, bị đẩy vậy?",
      "Ai đẩy {target} thế, {target} ổn mà?",
      "{target} uy tín mà, tôi bỏ lỡ gì à?",
      "Đừng treo {target}, có gì đâu?",
      "ủa sao đẩy {target}? {target} ổn mà.",
      "Tôi tin {target}, ai nghi thì nói?",
      "{target} sạch mà, có gì lạ đâu nhỉ?",
      "hmm sao đẩy {target} z? {target} ok mà.",
      "{target} ổn? dựa vào đâu?",
      "{target} an toàn mà, ai có gì ko?",
      "{target} ổn mà, đúng ko?",
      "sao {target} bị nhắm vậy? {target} ổn mà.",
    ],
  },
  ...
  ASK_EVIDENCE: {
    NEUTRAL: [
      ...
      "Cho tôi xin bằng chứng nhé, {author}.",
    ...
    FIRM: [
      "Bằng chứng đâu {author}.",
      "{author} đưa lý do ra đi.",
      "Không có căn cứ thì đừng nói nhé, {author}.",
      "{author} chứng minh đi.",
      "{author} ơi, bằng chứng.",
      "căn cứ, {author} ơi.",
      "{author} đưa ra đi.",
      "ko có gì thì im nhé, {author}.",
      "{author}, nguồn?",
      "{author} ơi, chứng minh.",
      "{author} nói suông à.",
      "lý do, {author} ơi, nhanh.",
      "{author}, đâu?",
    ],
    TENSE: [
      "{author} nói suông à.",
      "Bằng chứng đâu, {author}.",
      "{author} đừng chém nhé.",
      "Không có gì thì im, {author} ơi.",
      "{author}, chứng minh coi.",
      "chém gió à {author}.",
      "{author} à, có gì ko mà nói.",
      "haizz {author}, căn cứ?",
      "{author} nói cho có à.",
      "đâu, {author}, đâu?",
      "{author} bịa à.",
      "ko có căn cứ thì thôi {author} ơi.",
      "{author} à, nói suông hoài.",
    ],
    SOFT: [
      "{author} có gì để mình tin không?",
      "Mình muốn nghe lý do của {author} nhé.",
      ...
      "{author} à, có gì ko, mình tò mò.",
      "ừm {author}, lý do?",
      "{author} ơi, bằng chứng?",
      "mình xin {author} tí căn cứ nhé.",
    ...
    PLAYFUL: [
      ...
      "Ủa {author}, bịa à?",
      "Show hàng đi {author} ơi.",
      "{author} nổ à =))",
      "kkk {author}, nguồn?",
      "{author} chém hay ghê, nguồn?",
      "alo {author}, bằng chứng?",
      "{author} =)) dựa vào gì?",
      "{author} ơi có ảnh chụp ko =))",
      "haha {author}, kể coi.",
...
const TYPO_PROTECTED: ReadonlySet<string> = new Set([
  ...
  // Nhãn tố/bênh đứng sau tên (`ACCUSE_LABELS`, `DEFEND_LABELS`) và các động
  // từ phiếu (`PUSH_VERBS`, `SPARE_MARKERS`). Bảng mẫu giờ dựa vào chúng để
  // MỌI mẫu của một loại có mục tiêu đọc ngược được; rớt dấu một chữ ở đây là
  // mất nguyên lời tố đó với cả bàn. Có test quét cả bảng canh chuyện này.
  "xạo", "giả", "láo", "sủa", "dối", "đáng", "khả", "ngờ", "lươn", "lẹo",
  "chứ", "nữa", "sạch", "tội", "tín", "toàn", "hiền", "bầu", "chọn", "chốt",
  "đẩy", "phiếu",
  // `LABEL_INTENSIFIERS` - tiếng đệm mà parser LÙI QUA để với tới cái tên
  // ("{target} đang lươn quá đấy"). Rớt dấu ở một chữ đệm thì phép lùi dừng
  // ngay tại đó và cái tên không bao giờ được chạm tới: nhãn còn nguyên mà
  // lời tố vẫn mất. Đo được 1/1423 lượt ACCUSE đi lạc đúng theo đường này.
  "chắc", "chắn", "chuẩn", "quá", "rất", "hơi", "khá", "đích", "thị", "cũng",
  "đang", "vẫn",
]);
