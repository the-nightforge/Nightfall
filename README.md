...
| Guard | Bảo Vệ | Protect one player; never itself, and cannot repeat the same target two nights running |
| Guardian Angel | Thiên Thần Hộ Mệnh | Two shields per match; never itself, no consecutive repeats |
