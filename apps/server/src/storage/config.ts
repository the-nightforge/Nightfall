 ...
 *
 * Chuỗi rỗng tính như chưa đặt. Template `.env.example` ở gốc repo (dùng
 * cho dev local) điền sẵn cả sáu khoá bằng giá trị MinIO của docker-compose
 * để bật tính năng ngay, và nó copy-được mà không nổ - không có template nào
